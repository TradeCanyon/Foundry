...
/**
 * Global ACP Detector - Detects once at startup, shares result globally
 */
class AcpDetector {
  ...
  /**
   * Execute detection at startup - use POTENTIAL_ACP_CLIS list to detect installed CLIs
   */
  async initialize(): Promise<void> {
    ...
    // Parallel detection of all potential ACP CLIs
