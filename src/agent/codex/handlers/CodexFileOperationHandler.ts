...
/**
 * CodexFileOperationHandler - File operation capabilities based on ACP pattern
...
export class CodexFileOperationHandler {
  ...
  /**
   * Handle smart file references - based on ACP's @filename handling
   */
  ...
  private getChangeAction(change: FileChange): 'create' | 'write' | 'delete' {
    ...
    // Compatibility with old format - type-safe check
