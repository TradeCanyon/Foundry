...
export const MODEL_PLATFORMS: PlatformConfig[] = [
  ...
  // Preset providers (alphabetically ordered)
  ...
  { name: 'Ollama (Local)', value: 'Ollama', logo: null, platform: 'custom', baseUrl: 'http://localhost:11434/v1', i18nKey: 'settings.platformOllama' },
  { name: 'LM Studio (Local)', value: 'LMStudio', logo: null, platform: 'custom', baseUrl: 'http://localhost:1234/v1', i18nKey: 'settings.platformLMStudio' },
];
