...
const MCP_CATALOG: McpCatalogEntry[] = [
  ...
  { id: 'google-calendar', name: 'Google Calendar', description: 'Read and manage calendar events', category: 'Productivity', author: 'Community', transport: { type: 'stdio', command: 'npx', args: ['-y', 'mcp-server-google-calendar'] }, tags: ['google', 'calendar'] },
  { id: 'gmail', name: 'Gmail', description: 'Read, search, and send emails', category: 'Productivity', author: 'Community', transport: { type: 'stdio', command: 'npx', args: ['-y', 'mcp-server-gmail'] }, tags: ['google', 'email'] },
  { id: 'google-sheets', name: 'Google Sheets', description: 'Read and write spreadsheet data', category: 'Productivity', author: 'Community', transport: { type: 'stdio', command: 'npx', args: ['-y', 'mcp-server-google-sheets'] }, tags: ['google', 'sheets', 'spreadsheet'] },
  { id: 'todoist', name: 'Todoist', description: 'Manage tasks and projects in Todoist', category: 'Productivity', author: 'Community', transport: { type: 'stdio', command: 'npx', args: ['-y', 'mcp-server-todoist'] }, tags: ['todoist', 'tasks'] },
  { id: 'jira', name: 'Jira', description: 'Manage Jira issues and sprints', category: 'Productivity', author: 'Community', transport: { type: 'stdio', command: 'npx', args: ['-y', 'mcp-server-jira'] }, tags: ['jira', 'atlassian', 'issues'] },
  { id: 'obsidian', name: 'Obsidian', description: 'Read and search Obsidian vault notes', category: 'Productivity', author: 'Community', transport: { type: 'stdio', command: 'npx', args: ['-y', 'mcp-server-obsidian'] }, tags: ['obsidian', 'notes', 'markdown'] },
  { id: 'vercel', name: 'Vercel', description: 'Manage Vercel deployments and projects', category: 'Cloud', author: 'Community', transport: { type: 'stdio', command: 'npx', args: ['-y', 'mcp-server-vercel'] }, tags: ['vercel', 'deploy'] },
  { id: 'aws', name: 'AWS', description: 'Manage AWS services (S3, Lambda, EC2)', category: 'Cloud', author: 'Community', transport: { type: 'stdio', command: 'npx', args: ['-y', 'mcp-server-aws'] }, tags: ['aws', 'cloud', 's3'] },
  { id: 'perplexity', name: 'Perplexity Search', description: 'AI-powered web search via Perplexity', category: 'Web', author: 'Community', transport: { type: 'stdio', command: 'npx', args: ['-y', 'mcp-server-perplexity'] }, tags: ['search', 'perplexity', 'ai'] },
  { id: 'dropbox', name: 'Dropbox', description: 'Read and manage Dropbox files', category: 'Productivity', author: 'Community', transport: { type: 'stdio', command: 'npx', args: ['-y', 'mcp-server-dropbox'] }, tags: ['dropbox', 'files', 'storage'] },
  { id: 'google-workspace', name: 'Google Workspace', description: 'Unified Google Workspace access (Docs, Drive, Calendar, Gmail)', category: 'Productivity', author: 'Community', transport: { type: 'stdio', command: 'npx', args: ['-y', '@anthropic/mcp-server-google-workspace'] }, tags: ['google', 'workspace', 'docs'], repo: 'taylorwilsdon/google_workspace_mcp' },
];
