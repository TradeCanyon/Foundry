...
/**
 * Initialize color scheme immediately when module loads to avoid page flash
 */
...
const useColorScheme = (): [ColorScheme, (scheme: ColorScheme) => Promise<void>] => {
   ...
   * Read color scheme state from early initialization to ensure correct value when component mounts
   */
  useEffect(() => {
