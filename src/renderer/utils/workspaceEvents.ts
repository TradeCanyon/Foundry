export const WORKSPACE_TOGGLE_EVENT = 'foundry-workspace-toggle';
export const WORKSPACE_STATE_EVENT = 'foundry-workspace-state';
export const WORKSPACE_HAS_FILES_EVENT = 'foundry-workspace-has-files';
