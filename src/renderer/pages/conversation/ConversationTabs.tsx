...
const ConversationTabs: React.FC = () => {
  ...
  const handleCloseTab = useCallback(
    (tabId: string) => {
      closeTab(tabId);
      // If closing the current tab, navigation will be handled by context automatically (switch to last one)
      // If no tabs left, navigate to welcome page
  ...
  const handleNewConversation = useCallback(() => {
    ...
    // Get current conversation's full info from database
    void ipcBridge.database.getUserConversations
      ...
      .then((conversations) => {
        ...
        // Create new conversation, copy current conversation's config and title
        const newId = uuid();
