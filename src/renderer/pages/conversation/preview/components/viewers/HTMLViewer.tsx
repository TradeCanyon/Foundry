...
interface SelectedElement {
  ...
  startLine?: number; // Estimated code start line
  endLine?: number; // Estimated code end line
}

/**
 * HTML preview component
 * - Supports live preview and code editing
 * - Supports element selector (similar to DevTools)
 * - Supports bidirectional navigation: preview <-> code
 */
