 ...
 *
 * Due to the complexity of the PPT format, it cannot be perfectly rendered in pure JavaScript.
 * This component guides users to open the file in system applications (PowerPoint/Keynote/WPS).
 */
