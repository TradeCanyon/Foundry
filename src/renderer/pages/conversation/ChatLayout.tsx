...
const ChatLayout: React.FC<{
  ...
  // Get tabs state, hide conversation title when tabs are present
  ...
  useEffect(() => {
    ...
    // Intentionally not including workspaceSplitRatio in deps to avoid extra effect when dragging workspace
  ...
  useEffect(() => {
    ...
    // Intentionally not including workspaceSplitRatio in deps to avoid affecting chat panel when dragging workspace
    ...
    >
      ...
      <div ref={containerRef} className='flex flex-1 relative w-full overflow-hidden'>
        ...
        <div
          ...
          style={{
            // Use flexBasis for width to avoid conflict between width and flexBasis
        ...
        >
          ...
          {/* Chat right drag handle: adjust chat and preview width ratio in desktop mode */}
          {isPreviewOpen &&
            !layout?.isMobile &&
