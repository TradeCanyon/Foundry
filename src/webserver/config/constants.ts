...
export const CSRF_COOKIE_NAME = 'foundry-csrf-token';
 ...
 * Recommend configuring HTTPS in production and setting FOUNDRY_HTTPS=true
 */
export function getCookieOptions(): {
  ...
  const isHttps = process.env.FOUNDRY_HTTPS === 'true' || (process.env.NODE_ENV === 'production' && process.env.HTTPS === 'true');
