 ...
 *
 * Architecture:
 * 1. Global event listening via ChannelEventBus for Agent messages
 * 2. sendMessage(): Only sends messages and registers stream callbacks
 * 3. handleAgentMessage(): Processes message events
 *
 * Does not interact with Agent Task directly, fully decoupled via global event bus
 */
