 ...
 * MCP OAuth Service
 *
 * Responsible for managing OAuth authentication flow for MCP servers
 * Uses @office-ai/aioncli-core's OAuth functionality
 */
export class McpOAuthService {
   ...
   * Determines by attempting to connect and checking WWW-Authenticate header
   */
  async checkOAuthStatus(server: IMcpServer): Promise<OAuthStatus> {
    try {
      ...
      // Connection successful or no authentication needed
      return {
        isAuthenticated: true,
        needsLogin: false,
      };
