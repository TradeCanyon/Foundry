...
/**
 * List of known CLI tools that support ACP protocol.
 * During detection, this list is traversed and `which` command is used to check if installed.
 * Auto-generated from ACP_BACKENDS_ALL to avoid data redundancy.
 */
...
export const ACP_BACKENDS_ALL: Record<AcpBackendAll, AcpBackendConfig> = {
  ...
  codex: {
    ...
    cliCommand: 'codex',
    authRequired: false,
    enabled: true, // Verified: Codex CLI v0.4.0+ supports acp mode
    supportsStreaming: false,
  },
  goose: {
    id: 'goose',
    ...
    cliCommand: 'goose',
    authRequired: false,
    enabled: true, // Block's Goose CLI, launched with `goose acp`
    supportsStreaming: false,
  ...
  auggie: {
    ...
    cliCommand: 'auggie',
    authRequired: false,
    enabled: true, // Augment Code CLI, launched with `auggie --acp`
    supportsStreaming: false,
  ...
  kimi: {
    ...
    cliCommand: 'kimi',
    authRequired: false,
    enabled: true, // Kimi CLI (Moonshot), launched with `kimi acp`
    supportsStreaming: false,
  ...
  opencode: {
    ...
    cliCommand: 'opencode',
    authRequired: false,
    enabled: true, // OpenCode CLI, launched with `opencode acp`
    supportsStreaming: false,
