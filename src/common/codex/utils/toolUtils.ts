...
/**
 * Tool Registry - responsible for managing tool registration, discovery and resolution
 */
export class ToolRegistry {
  ...
  /**
   * Adapt MCP tool to standard tool definition
   */
  ...
  /**
   * Resolve corresponding tool based on event type and data
   */
  ...
  /**
   * Generate localization params for MCP tool
   */
