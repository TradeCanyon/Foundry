...
export enum CodexAgentEventType {
  ...
  /**
   * Task started event - agent has begun task
   * prompt: 'hello codex'
  ...
  /**
   * Agent message delta event - incremental text output from agent (streaming delta message)
   * prompt: 'hello codex'
   ...
   * prompt: 'Where can I find the interface docs for codex message format?'
   * payload: { text: string }
   */
  AGENT_REASONING = 'agent_reasoning',

  /**
   * Agent reasoning delta event - incremental reasoning event from agent (streaming text output)
   ...
   * prompt: 'TypeScript compile error: Property X does not exist, help me analyze the cause'
   * payload: { text: string }
   */
  ...
  /**
   * Agent reasoning section break event - signals when model starts new reasoning summary section (e.g., new heading block)
   * prompt: 'TypeScript compile error: Property X does not exist, help me analyze the cause'
   * payload: {}
   */
  ...
  /**
   * Exec command begin event - notifies server that command is about to execute
   * prompt: 'TypeScript compile error: Property X does not exist, help me analyze the cause'
   * payload: {
      "type": "exec_command_begin",
      "call_id": "call_vufa8VWQV91WSWcc5BlFTsmQ",
      "command": [ "bash", "-lc", "ls -a" ],
      "cwd": "/Users/pojian/Library/Application Support/Foundry/foundry/codex-temp-1758954404275",
      "parsed_cmd": [
        {
        "type": "list_files",
        "cmd": "ls -a",
  ...
  /**
   * Exec command end event - indicates command execution completed
   * prompt: 'TypeScript compile error: Property X does not exist, help me analyze the cause'
   * payload: {
   ...
   * prompt: Write a file using apply_patch <<'PATCH' ... PATCH command, you decide the content and filename
   * payload: {
      "type": "patch_apply_begin",
          "call_id": "call_3tChlyDszdHuQRQTWnuZ8Jvb",
          "auto_approved": false,
          "changes": {
            "/Users/pojian/Library/Application Support/Foundry/foundry/codex-temp-1759144414815/note.txt": {
            "add": {
  ...
  /**
   * Patch apply end event - notifies that patch application completed
   * prompt: Write a file using apply_patch <<'PATCH' ... PATCH command, you decide the content and filename
   * payload: {
  ...
  // MCP tool events
  /**
   * MCP tool call begin event - indicates MCP tool call started
   * tips: Need to install codex mcp add 12306-mcp first, 12306-mcp is an MCP server, more MCPs at https://modelscope.cn/mcp?page=1, verify installation with codex mcp list
  ...
  /**
   * MCP tool call end event - indicates MCP tool call completed
   *
   * prompt: Help me query high-speed rail tickets from Shenzhen to Guangzhou on 2025-10-10
   * payload: {
  ...
  /**
   * MCP list tools response event - list of MCP tools available to agent
  ...
  // Web search events
  /**
   * Web search begin event - indicates web search started
   * tips: web_search capability needs to be enabled manually, add web_search = true in ~/.codex/config.toml
   * prompt: Find TypeScript 5.0 new features, don't use existing knowledge, search official site for latest info
   * payload: {
  ...
  /**
   * Web search end event - indicates web search completed
   * prompt: Find TypeScript 5.0 new features, don't use existing knowledge, search official site for latest info
   * payload: {
   *  "type":"web_search_end",
   *  "call_id":"ws_010bdd5c4db8ef410168da04c74a648196b7e30cb864885b26",
   ...
   * payload: {
      ...
      "unified_diff": "diff --git a//Users/pojian/Library/Application Support/Foundry/foundry/codex-temp-1759197123355/freestyle.txt b//Users/pojian/Library/Application Support/Foundry/foundry/codex-temp-1759197123355/freestyle.txt\nnew file mode 100644\nindex 0000000000000000000000000000000000000000..151e31d7a6627e3fb0df2e49b3c0c179f96e46cc\n--- /dev/null\n+++ b//Users/pojian/Library/Application Support/Foundry/foundry/codex-temp-1759197123355/freestyle.txt\n@@ -0,0 +1,2 @@\n+This file was created via apply_patch.\n+Line two says hello.\n"
    }
   */
  TURN_DIFF = 'turn_diff',
  ...
  /**
   * List custom prompts response event - list of custom prompts available to agent
